...
namespace Scripting
{
	static int GET_MAP_AREA_FROM_COORDS(float x, float y, float z) { return NativeInvoke::Invoke< int>(NATIVE_GET_MAP_AREA_FROM_COORDS, x, y, z); }
...
//	static void GET_DEAD_CHAR_COORDINATES(Ped ped, float* pX, float* pY, float* pZ) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_GET_DEAD_CHAR_COORDINATES, ped, pX, pY, pZ); }
	...
	static void SET_CHAR_COORDINATES_NO_OFFSET(Ped ped, float x, float y, float z) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_SET_CHAR_COORDINATES_NO_OFFSET, ped, x, y, z); }
...
//	static void DETACH_PED_FROM_WITHIN_CAR(Ped ped, b8 unknown) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_DETACH_PED_FROM_WITHIN_CAR, ped, unknown); }
	...
	static void TASK_ACHIEVE_HEADING(Ped ped, float heading) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_ACHIEVE_HEADING, ped, heading); }
	static void TASK_AIM_GUN_AT_CHAR(Ped ped, Ped targetPed, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_AIM_GUN_AT_CHAR, ped, targetPed, duration); }
	static void TASK_AIM_GUN_AT_COORD(Ped ped, float tX, float tY, float tZ, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_AIM_GUN_AT_COORD, ped, tX, tY, tZ, duration); }
	static void TASK_CAR_DRIVE_TO_COORD(Ped ped, Vehicle veh, float Unk133, float Unk134, float Unk135, float Unk136, int Unk137, int Unk138, int Unk139, float Unk140, int Unk141) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_DRIVE_TO_COORD, ped, veh, Unk133, Unk134, Unk135, Unk136, Unk137, Unk138, Unk139, Unk140, Unk141); }
	static void TASK_CAR_DRIVE_TO_COORD_NOT_AGAINST_TRAFFIC(Ped ped, ScriptAny Unk142, ScriptAny Unk143, ScriptAny Unk144, ScriptAny Unk145, ScriptAny Unk146, ScriptAny Unk147, ScriptAny Unk148, ScriptAny Unk149, ScriptAny Unk150, ScriptAny Unk151) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_DRIVE_TO_COORD_NOT_AGAINST_TRAFFIC, ped, Unk142, Unk143, Unk144, Unk145, Unk146, Unk147, Unk148, Unk149, Unk150, Unk151); }
	static void TASK_CAR_DRIVE_WANDER(Ped ped, Vehicle vehicle, float speed, unsigned int drivingStyle) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_DRIVE_WANDER, ped, vehicle, speed, drivingStyle); }
	static void TASK_CAR_MISSION(Ped ped, Vehicle vehicle, unsigned int targetEntity, unsigned int missionType, float speed, unsigned int drivingStyle, unsigned int unknown6_10, unsigned int unknown7_5) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_MISSION, ped, vehicle, targetEntity, missionType, speed, drivingStyle, unknown6_10, unknown7_5); }
	static void TASK_CAR_MISSION_COORS_TARGET(Ped ped, Vehicle vehicle, float x, float y, float z, unsigned int unknown0_4, float speed, unsigned int unknown2_1, unsigned int unknown3_5, unsigned int unknown4_10) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_MISSION_COORS_TARGET, ped, vehicle, x, y, z, unknown0_4, speed, unknown2_1, unknown3_5, unknown4_10); }
	static void TASK_CAR_MISSION_COORS_TARGET_NOT_AGAINST_TRAFFIC(Ped ped, Vehicle vehicle, float x, float y, float z, unsigned int unknown0_4, float speed, unsigned int unknown2_1, unsigned int unknown3_5, unsigned int unknown4_10) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_MISSION_COORS_TARGET_NOT_AGAINST_TRAFFIC, ped, vehicle, x, y, z, unknown0_4, speed, unknown2_1, unknown3_5, unknown4_10); }
	static void TASK_CAR_MISSION_NOT_AGAINST_TRAFFIC(Ped ped, Vehicle vehicle, unsigned int targetEntity, unsigned int missionType, float speed, unsigned int drivingStyle, unsigned int unknown6_10, unsigned int unknown7_5) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_MISSION_NOT_AGAINST_TRAFFIC, ped, vehicle, targetEntity, missionType, speed, drivingStyle, unknown6_10, unknown7_5); }
	static void TASK_CAR_MISSION_PED_TARGET(Ped ped, Vehicle vehicle, Ped target, unsigned int unknown0_4, float speed, unsigned int unknown2_1, unsigned int unknown3_5, unsigned int unknown4_10) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_MISSION_PED_TARGET, ped, vehicle, target, unknown0_4, speed, unknown2_1, unknown3_5, unknown4_10); }
	static void TASK_CAR_MISSION_PED_TARGET_NOT_AGAINST_TRAFFIC(Ped ped, ScriptAny Unk152, ScriptAny Unk153, ScriptAny Unk154, ScriptAny Unk155, ScriptAny Unk156, ScriptAny Unk157, ScriptAny Unk158) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_MISSION_PED_TARGET_NOT_AGAINST_TRAFFIC, ped, Unk152, Unk153, Unk154, Unk155, Unk156, Unk157, Unk158); }
	static void TASK_CAR_TEMP_ACTION(Ped ped, Vehicle vehicle, unsigned int action, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CAR_TEMP_ACTION, ped, vehicle, action, duration); }
	static void TASK_CHAR_ARREST_CHAR(Ped ped0, Ped ped1) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CHAR_ARREST_CHAR, ped0, ped1); }
	static void TASK_CHAR_SLIDE_TO_COORD(Ped ped, ScriptAny Unk159, ScriptAny Unk160, ScriptAny Unk161, ScriptAny Unk162, ScriptAny Unk163) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CHAR_SLIDE_TO_COORD, ped, Unk159, Unk160, Unk161, Unk162, Unk163); }
	static void TASK_CHAR_SLIDE_TO_COORD_AND_PLAY_ANIM(Ped ped, ScriptAny Unk164, ScriptAny Unk165, ScriptAny Unk166, ScriptAny Unk167, ScriptAny Unk168, ScriptAny Unk169, ScriptAny Unk170, ScriptAny Unk171, ScriptAny Unk172, ScriptAny Unk173, ScriptAny Unk174, ScriptAny Unk175, ScriptAny Unk176) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CHAR_SLIDE_TO_COORD_AND_PLAY_ANIM, ped, Unk164, Unk165, Unk166, Unk167, Unk168, Unk169, Unk170, Unk171, Unk172, Unk173, Unk174, Unk175, Unk176); }
	static void TASK_CHAR_SLIDE_TO_COORD_HDG_RATE(Ped ped, ScriptAny Unk177, ScriptAny Unk178, ScriptAny Unk179, ScriptAny Unk180, ScriptAny Unk181, ScriptAny Unk182) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CHAR_SLIDE_TO_COORD_HDG_RATE, ped, Unk177, Unk178, Unk179, Unk180, Unk181, Unk182); }
	static void TASK_CHAT_WITH_CHAR(Ped ped, Ped pednext, b8 Unk183, b8 Unk184) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CHAT_WITH_CHAR, ped, pednext, Unk183, Unk184); }
	static void TASK_CLEAR_LOOK_AT(Ped ped) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CLEAR_LOOK_AT, ped); }
	static void TASK_CLIMB(Ped ped, b8 Unk185) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CLIMB, ped, Unk185); }
	static void TASK_CLIMB_LADDER(Ped ped, ScriptAny Unk186) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_CLIMB_LADDER, ped, Unk186); }
	static void TASK_COMBAT(Ped ped, Ped target) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_COMBAT, ped, target); }
	static void TASK_COMBAT_HATED_TARGETS_AROUND_CHAR(Ped ped, float radius) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_COMBAT_HATED_TARGETS_AROUND_CHAR, ped, radius); }
	static void TASK_COMBAT_HATED_TARGETS_AROUND_CHAR_TIMED(Ped ped, float radius, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_COMBAT_HATED_TARGETS_AROUND_CHAR_TIMED, ped, radius, duration); }
	static void TASK_COMBAT_HATED_TARGETS_IN_AREA(Ped ped, ScriptAny Unk187, ScriptAny Unk188, ScriptAny Unk189, ScriptAny Unk190) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_COMBAT_HATED_TARGETS_IN_AREA, ped, Unk187, Unk188, Unk189, Unk190); }
	static void TASK_COMBAT_ROLL(Ped ped, ScriptAny Unk191) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_COMBAT_ROLL, ped, Unk191); }
	static void TASK_COMBAT_TIMED(Ped ped, Ped target, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_COMBAT_TIMED, ped, target, duration); }
	static void TASK_COWER(Ped ped) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_COWER, ped); }
	static void TASK_DEAD(Ped ped) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_DEAD, ped); }
	static void TASK_DESTROY_CAR(Ped ped, Vehicle car) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_DESTROY_CAR, ped, car); }
	static void TASK_DIE(Ped ped) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_DIE, ped); }
	static void TASK_DRIVE_BY(Ped ped, Ped pednext, int Unk192, float x, float y, float z, float angle, int Unk193, b8 Unk194, int Unk195) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_DRIVE_BY, ped, pednext, Unk192, x, y, z, angle, Unk193, Unk194, Unk195); }
	static void TASK_DRIVE_POINT_ROUTE(Ped ped, int point, float radius) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_DRIVE_POINT_ROUTE, ped, point, radius); }
	static void TASK_DRIVE_POINT_ROUTE_ADVANCED(Ped ped, ScriptAny Unk197, ScriptAny Unk198, ScriptAny Unk199, ScriptAny Unk200, ScriptAny Unk201) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_DRIVE_POINT_ROUTE_ADVANCED, ped, Unk197, Unk198, Unk199, Unk200, Unk201); }
	static void TASK_DUCK(Ped ped, ScriptAny Unk202) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_DUCK, ped, Unk202); }
	static void TASK_ENTER_CAR_AS_DRIVER(Ped ped, Vehicle vehicle, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_ENTER_CAR_AS_DRIVER, ped, vehicle, duration); }
	static void TASK_ENTER_CAR_AS_PASSENGER(Ped ped, Vehicle vehicle, unsigned int duration, unsigned int seatIndex) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_ENTER_CAR_AS_PASSENGER, ped, vehicle, duration, seatIndex); }
	static void TASK_EVERYONE_LEAVE_CAR(Vehicle vehicle) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_EVERYONE_LEAVE_CAR, vehicle); }
	static void TASK_EXTEND_ROUTE(Ped ped, ScriptAny Unk203, ScriptAny Unk204) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_EXTEND_ROUTE, ped, Unk203, Unk204); }
	static void TASK_FALL_AND_GET_UP(Ped ped, ScriptAny Unk205, ScriptAny Unk206) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_FALL_AND_GET_UP, ped, Unk205, Unk206); }
	static void TASK_FLEE_CHAR_ANY_MEANS(Ped ped, ScriptAny Unk207, ScriptAny Unk208, ScriptAny Unk209, ScriptAny Unk210, ScriptAny Unk211, ScriptAny Unk212, ScriptAny Unk213) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_FLEE_CHAR_ANY_MEANS, ped, Unk207, Unk208, Unk209, Unk210, Unk211, Unk212, Unk213); }
	static void TASK_FLUSH_ROUTE() { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_FLUSH_ROUTE); }
	static void TASK_FOLLOW_FOOTSTEPS(Ped ped, ScriptAny Unk214) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_FOLLOW_FOOTSTEPS, ped, Unk214); }
	static void TASK_FOLLOW_NAV_MESH_AND_SLIDE_TO_COORD(Ped ped, float x, float y, float z, int Unk215, int Unk216, float Unk217, float angle) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_FOLLOW_NAV_MESH_AND_SLIDE_TO_COORD, ped, x, y, z, Unk215, Unk216, Unk217, angle); }
	static void TASK_FOLLOW_NAV_MESH_TO_COORD(Ped ped, float x, float y, float z, unsigned int unknown0_2, unsigned int unknown1_minus1, float unknown2_1) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_FOLLOW_NAV_MESH_TO_COORD, ped, x, y, z, unknown0_2, unknown1_minus1, unknown2_1); }
	static void TASK_FOLLOW_NAV_MESH_TO_COORD_NO_STOP(Ped ped, float x, float y, float z, unsigned int unknown0_2, unsigned int unknown1_minus1, float unknown2_1) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_FOLLOW_NAV_MESH_TO_COORD_NO_STOP, ped, x, y, z, unknown0_2, unknown1_minus1, unknown2_1); }
	static void TASK_GET_OFF_BOAT(Ped ped, int timeout) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GET_OFF_BOAT, ped, timeout); }
	static void TASK_GOTO_CAR(Ped ped, ScriptAny Unk221, ScriptAny Unk222, ScriptAny Unk223) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GOTO_CAR, ped, Unk221, Unk222, Unk223); }
	static void TASK_GOTO_CHAR_AIMING(Ped ped, ScriptAny Unk224, ScriptAny Unk225, ScriptAny Unk226) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GOTO_CHAR_AIMING, ped, Unk224, Unk225, Unk226); }
	static void TASK_GOTO_CHAR_OFFSET(Ped ped, Ped target, unsigned int duration, float offsetRight, float offsetFront) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GOTO_CHAR_OFFSET, ped, target, duration, offsetRight, offsetFront); }
	static void TASK_GO_STRAIGHT_TO_COORD(Ped ped, float x, float y, float z, unsigned int unknown2, unsigned int unknown45000) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GO_STRAIGHT_TO_COORD, ped, x, y, z, unknown2, unknown45000); }
	static void TASK_GO_STRAIGHT_TO_COORD_RELATIVE_TO_CAR(Ped ped, ScriptAny Unk227, ScriptAny Unk228, ScriptAny Unk229, ScriptAny Unk230, ScriptAny Unk231, ScriptAny Unk232) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GO_STRAIGHT_TO_COORD_RELATIVE_TO_CAR, ped, Unk227, Unk228, Unk229, Unk230, Unk231, Unk232); }
	static void TASK_GO_TO_CHAR(Ped ped, ScriptAny Unk233, ScriptAny Unk234, ScriptAny Unk235) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GO_TO_CHAR, ped, Unk233, Unk234, Unk235); }
	static void TASK_GO_TO_COORD_ANY_MEANS(Ped ped, ScriptAny Unk236, ScriptAny Unk237, ScriptAny Unk238, ScriptAny Unk239, ScriptAny Unk240) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GO_TO_COORD_ANY_MEANS, ped, Unk236, Unk237, Unk238, Unk239, Unk240); }
	static void TASK_GO_TO_COORD_WHILE_AIMING(Ped ped, ScriptAny Unk241, ScriptAny Unk242, ScriptAny Unk243, ScriptAny Unk244, ScriptAny Unk245, ScriptAny Unk246, ScriptAny Unk247, ScriptAny Unk248, ScriptAny Unk249, ScriptAny Unk250, ScriptAny Unk251) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GO_TO_COORD_WHILE_AIMING, ped, Unk241, Unk242, Unk243, Unk244, Unk245, Unk246, Unk247, Unk248, Unk249, Unk250, Unk251); }
	static void TASK_GO_TO_COORD_WHILE_SHOOTING(Ped ped, ScriptAny Unk252, ScriptAny Unk253, ScriptAny Unk254, ScriptAny Unk255, ScriptAny Unk256, ScriptAny Unk257, ScriptAny Unk258, ScriptAny Unk259) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GO_TO_COORD_WHILE_SHOOTING, ped, Unk252, Unk253, Unk254, Unk255, Unk256, Unk257, Unk258, Unk259); }
	static void TASK_GO_TO_OBJECT(Ped ped, ScriptAny Unk260, ScriptAny Unk261, ScriptAny Unk262) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GO_TO_OBJECT, ped, Unk260, Unk261, Unk262); }
	static void TASK_GUARD_ANGLED_DEFENSIVE_AREA(Ped ped, ScriptAny Unk263, ScriptAny Unk264, ScriptAny Unk265, ScriptAny Unk266, ScriptAny Unk267, ScriptAny Unk268, ScriptAny Unk269, ScriptAny Unk270, ScriptAny Unk271, ScriptAny Unk272, ScriptAny Unk273, ScriptAny Unk274, ScriptAny Unk275) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GUARD_ANGLED_DEFENSIVE_AREA, ped, Unk263, Unk264, Unk265, Unk266, Unk267, Unk268, Unk269, Unk270, Unk271, Unk272, Unk273, Unk274, Unk275); }
	static void TASK_GUARD_ASSIGNED_DEFENSIVE_AREA(Ped ped, ScriptAny Unk276, ScriptAny Unk277, ScriptAny Unk278, ScriptAny Unk279, ScriptAny Unk280, ScriptAny Unk281) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GUARD_ASSIGNED_DEFENSIVE_AREA, ped, Unk276, Unk277, Unk278, Unk279, Unk280, Unk281); }
	static void TASK_GUARD_CURRENT_POSITION(Ped ped, float unknown0_15, float unknown1_10, unsigned int unknown2_1) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_GUARD_CURRENT_POSITION, ped, unknown0_15, unknown1_10, unknown2_1); }
	...
	static void TASK_HANDS_UP(Ped ped, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_HANDS_UP, ped, duration); }
	...
	static void TASK_JUMP(Ped ped, b8 flag) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_JUMP, ped, flag); }
	static void TASK_LEAVE_ANY_CAR(Ped ped) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LEAVE_ANY_CAR, ped); }
	static void TASK_LEAVE_CAR(Ped ped, Vehicle vehicle) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LEAVE_CAR, ped, vehicle); }
	static void TASK_LEAVE_CAR_AND_FLEE(Ped ped, ScriptAny Unk292, ScriptAny Unk293, ScriptAny Unk294, ScriptAny Unk295) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LEAVE_CAR_AND_FLEE, ped, Unk292, Unk293, Unk294, Unk295); }
	static void TASK_LEAVE_CAR_DONT_CLOSE_DOOR(Ped ped, Vehicle vehicle) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LEAVE_CAR_DONT_CLOSE_DOOR, ped, vehicle); }
	static void TASK_LEAVE_CAR_IMMEDIATELY(Ped ped, Vehicle vehicle) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LEAVE_CAR_IMMEDIATELY, ped, vehicle); }
	static void TASK_LEAVE_CAR_IN_DIRECTION(Ped ped, Vehicle car, b8 direction) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LEAVE_CAR_IN_DIRECTION, ped, car, direction); }
	static void TASK_LEAVE_GROUP(Ped ped) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LEAVE_GROUP, ped); }
	static void TASK_LOOK_AT_CHAR(Ped ped, Ped targetPed, unsigned int duration, unsigned int unknown_0) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LOOK_AT_CHAR, ped, targetPed, duration, unknown_0); }
	static void TASK_LOOK_AT_COORD(Ped ped, float x, float y, float z, unsigned int duration, unsigned int unknown_0) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LOOK_AT_COORD, ped, x, y, z, duration, unknown_0); }
	static void TASK_LOOK_AT_OBJECT(Ped ped, Object targetObject, unsigned int duration, unsigned int unknown_0) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LOOK_AT_OBJECT, ped, targetObject, duration, unknown_0); }
	static void TASK_LOOK_AT_VEHICLE(Ped ped, Vehicle targetVehicle, unsigned int duration, unsigned int unknown_0) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_LOOK_AT_VEHICLE, ped, targetVehicle, duration, unknown_0); }
	static void TASK_MOBILE_CONVERSATION(Ped ped, ScriptAny Unk296) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_MOBILE_CONVERSATION, ped, Unk296); }
	static void TASK_OPEN_DRIVER_DOOR(Ped ped, Vehicle vehicle, unsigned int unknown0) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_OPEN_DRIVER_DOOR, ped, vehicle, unknown0); }
	static void TASK_OPEN_PASSENGER_DOOR(Ped ped, Vehicle vehicle, unsigned int seatIndex, unsigned int unknown0) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_OPEN_PASSENGER_DOOR, ped, vehicle, seatIndex, unknown0); }
	static void TASK_PAUSE(Ped ped, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PAUSE, ped, duration); }
	static void TASK_PERFORM_SEQUENCE(Ped ped, TaskSequence taskSequence) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PERFORM_SEQUENCE, ped, taskSequence); }
	static void TASK_PERFORM_SEQUENCE_FROM_PROGRESS(Ped ped, ScriptAny Unk297, ScriptAny Unk298, ScriptAny Unk299) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PERFORM_SEQUENCE_FROM_PROGRESS, ped, Unk297, Unk298, Unk299); }
	static void TASK_PERFORM_SEQUENCE_LOCALLY(Ped ped, ScriptAny Unk300) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PERFORM_SEQUENCE_LOCALLY, ped, Unk300); }
	static void TASK_PICKUP_AND_CARRY_OBJECT(Ped ped, ScriptAny Unk301, ScriptAny Unk302, ScriptAny Unk303, ScriptAny Unk304, ScriptAny Unk305) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PICKUP_AND_CARRY_OBJECT, ped, Unk301, Unk302, Unk303, Unk304, Unk305); }
	static void TASK_PLAY_ANIM(Ped ped, ScriptAny Unk306, ScriptAny Unk307, ScriptAny Unk308, ScriptAny Unk309, ScriptAny Unk310, ScriptAny Unk311, ScriptAny Unk312, ScriptAny Unk313) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM, ped, Unk306, Unk307, Unk308, Unk309, Unk310, Unk311, Unk312, Unk313); }
	static void TASK_PLAY_ANIM_FACIAL(Ped ped, const char* Unk314, const char* Unk315, float Unk316, int Unk317, int Unk318, int Unk319) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_FACIAL, ped, Unk314, Unk315, Unk316, Unk317, Unk318, Unk319); }
	static void TASK_PLAY_ANIM_NON_INTERRUPTABLE(Ped ped, const char* animname0, const char* animname1, float Unk320, int Unk321, int Unk322, int Unk323, int Unk324, int Unk325) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_NON_INTERRUPTABLE, ped, animname0, animname1, Unk320, Unk321, Unk322, Unk323, Unk324, Unk325); }
	static void TASK_PLAY_ANIM_ON_CLONE(Ped ped, ScriptAny Unk326, ScriptAny Unk327, ScriptAny Unk328, ScriptAny Unk329, ScriptAny Unk330, ScriptAny Unk331, ScriptAny Unk332, ScriptAny Unk333) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_ON_CLONE, ped, Unk326, Unk327, Unk328, Unk329, Unk330, Unk331, Unk332, Unk333); }
	static void TASK_PLAY_ANIM_READY_TO_BE_EXECUTED(Ped ped, ScriptAny Unk334, ScriptAny Unk335, ScriptAny Unk336) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_READY_TO_BE_EXECUTED, ped, Unk334, Unk335, Unk336); }
	static void TASK_PLAY_ANIM_SECONDARY(Ped ped, ScriptAny Unk337, ScriptAny Unk338, ScriptAny Unk339, ScriptAny Unk340, ScriptAny Unk341, ScriptAny Unk342, ScriptAny Unk343, ScriptAny Unk344) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_SECONDARY, ped, Unk337, Unk338, Unk339, Unk340, Unk341, Unk342, Unk343, Unk344); }
	static void TASK_PLAY_ANIM_SECONDARY_IN_CAR(Ped ped, ScriptAny Unk345, ScriptAny Unk346, ScriptAny Unk347, ScriptAny Unk348, ScriptAny Unk349, ScriptAny Unk350, ScriptAny Unk351, ScriptAny Unk352) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_SECONDARY_IN_CAR, ped, Unk345, Unk346, Unk347, Unk348, Unk349, Unk350, Unk351, Unk352); }
	static void TASK_PLAY_ANIM_SECONDARY_NO_INTERRUPT(Ped ped, ScriptAny Unk353, ScriptAny Unk354, ScriptAny Unk355, ScriptAny Unk356, ScriptAny Unk357, ScriptAny Unk358, ScriptAny Unk359, ScriptAny Unk360) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_SECONDARY_NO_INTERRUPT, ped, Unk353, Unk354, Unk355, Unk356, Unk357, Unk358, Unk359, Unk360); }
	static void TASK_PLAY_ANIM_SECONDARY_UPPER_BODY(Ped ped, ScriptAny Unk361, ScriptAny Unk362, ScriptAny Unk363, ScriptAny Unk364, ScriptAny Unk365, ScriptAny Unk366, ScriptAny Unk367, ScriptAny Unk368) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_SECONDARY_UPPER_BODY, ped, Unk361, Unk362, Unk363, Unk364, Unk365, Unk366, Unk367, Unk368); }
	static void TASK_PLAY_ANIM_UPPER_BODY(Ped ped, ScriptAny Unk369, ScriptAny Unk370, ScriptAny Unk371, ScriptAny Unk372, ScriptAny Unk373, ScriptAny Unk374, ScriptAny Unk375, ScriptAny Unk376) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_UPPER_BODY, ped, Unk369, Unk370, Unk371, Unk372, Unk373, Unk374, Unk375, Unk376); }
	static void TASK_PLAY_ANIM_WITH_ADVANCED_FLAGS(Ped ped, ScriptAny Unk377, ScriptAny Unk378, ScriptAny Unk379, ScriptAny Unk380, ScriptAny Unk381, ScriptAny Unk382, ScriptAny Unk383, ScriptAny Unk384, ScriptAny Unk385, ScriptAny Unk386, ScriptAny Unk387) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_WITH_ADVANCED_FLAGS, ped, Unk377, Unk378, Unk379, Unk380, Unk381, Unk382, Unk383, Unk384, Unk385, Unk386, Unk387); }
	static void TASK_PLAY_ANIM_WITH_FLAGS(Ped ped, const char* animName, const char* animSet, float unknown0_8, unsigned int unknown1_0, unsigned int flags) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PLAY_ANIM_WITH_FLAGS, ped, animName, animSet, unknown0_8, unknown1_0, flags); }
	static void TASK_PUT_CHAR_DIRECTLY_INTO_COVER(ScriptAny Unk394, ScriptAny Unk395, ScriptAny Unk396, ScriptAny Unk397, ScriptAny Unk398) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_PUT_CHAR_DIRECTLY_INTO_COVER, Unk394, Unk395, Unk396, Unk397, Unk398); }
	static void TASK_SEEK_COVER_FROM_PED(Ped ped, ScriptAny Unk399, ScriptAny Unk400) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SEEK_COVER_FROM_PED, ped, Unk399, Unk400); }
	static void TASK_SEEK_COVER_FROM_POS(Ped ped, ScriptAny Unk401, ScriptAny Unk402, ScriptAny Unk403, ScriptAny Unk404) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SEEK_COVER_FROM_POS, ped, Unk401, Unk402, Unk403, Unk404); }
	static void TASK_SEEK_COVER_TO_COORDS(Ped ped, ScriptAny Unk405, ScriptAny Unk406, ScriptAny Unk407, ScriptAny Unk408, ScriptAny Unk409, ScriptAny Unk410, ScriptAny Unk411) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SEEK_COVER_TO_COORDS, ped, Unk405, Unk406, Unk407, Unk408, Unk409, Unk410, Unk411); }
	static void TASK_SEEK_COVER_TO_COVER_POINT(Ped ped, ScriptAny Unk412, ScriptAny Unk413, ScriptAny Unk414, ScriptAny Unk415, ScriptAny Unk416) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SEEK_COVER_TO_COVER_POINT, ped, Unk412, Unk413, Unk414, Unk415, Unk416); }
	static void TASK_SEEK_COVER_TO_OBJECT(Ped ped, ScriptAny Unk417, ScriptAny Unk418, ScriptAny Unk419, ScriptAny Unk420, ScriptAny Unk421) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SEEK_COVER_TO_OBJECT, ped, Unk417, Unk418, Unk419, Unk420, Unk421); }
	static void TASK_SET_IGNORE_WEAPON_RANGE_FLAG(Ped ped, b8 ignore) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SET_IGNORE_WEAPON_RANGE_FLAG, ped, ignore); }
	static void TASK_SHAKE_FIST(Ped ped) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SHAKE_FIST, ped); }
	static void TASK_SHIMMY(Ped ped, ScriptAny Unk422) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SHIMMY, ped, Unk422); }
	static void TASK_SHOOT_AT_CHAR(Ped shooter, Ped victim, int time, int shootmode) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SHOOT_AT_CHAR, shooter, victim, time, shootmode); }
	static void TASK_SHOOT_AT_COORD(Ped ped, ScriptAny Unk423, ScriptAny Unk424, ScriptAny Unk425, ScriptAny Unk426, ScriptAny Unk427) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SHOOT_AT_COORD, ped, Unk423, Unk424, Unk425, Unk426, Unk427); }
	static void TASK_SHUFFLE_TO_NEXT_CAR_SEAT(Ped ped, ScriptAny Unk428) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SHUFFLE_TO_NEXT_CAR_SEAT, ped, Unk428); }
	static void TASK_SIT_DOWN(Ped ped, ScriptAny Unk429, ScriptAny Unk430, ScriptAny Unk431) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SIT_DOWN, ped, Unk429, Unk430, Unk431); }
	static void TASK_SIT_DOWN_INSTANTLY(Ped ped, ScriptAny Unk432, ScriptAny Unk433, ScriptAny Unk434) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SIT_DOWN_INSTANTLY, ped, Unk432, Unk433, Unk434); }
	static void TASK_SIT_DOWN_ON_NEAREST_OBJECT(Ped ped, ScriptAny Unk435, ScriptAny Unk436, ScriptAny Unk437, ScriptAny Unk438, ScriptAny Unk439, ScriptAny Unk440, ScriptAny Unk441, ScriptAny Unk442, ScriptAny Unk443) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SIT_DOWN_ON_NEAREST_OBJECT, ped, Unk435, Unk436, Unk437, Unk438, Unk439, Unk440, Unk441, Unk442, Unk443); }
	static void TASK_SIT_DOWN_ON_OBJECT(Ped ped, ScriptAny Unk444, ScriptAny Unk445, ScriptAny Unk446, ScriptAny Unk447, ScriptAny Unk448, ScriptAny Unk449, ScriptAny Unk450, ScriptAny Unk451, ScriptAny Unk452) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SIT_DOWN_ON_OBJECT, ped, Unk444, Unk445, Unk446, Unk447, Unk448, Unk449, Unk450, Unk451, Unk452); }
	static void TASK_SIT_DOWN_ON_SEAT(Ped ped, ScriptAny Unk453, ScriptAny Unk454, ScriptAny Unk455, ScriptAny Unk456, ScriptAny Unk457, ScriptAny Unk458, ScriptAny Unk459) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SIT_DOWN_ON_SEAT, ped, Unk453, Unk454, Unk455, Unk456, Unk457, Unk458, Unk459); }
	static void TASK_SMART_FLEE_CHAR(Ped ped, Ped fleeFromPed, float unknown0_100, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SMART_FLEE_CHAR, ped, fleeFromPed, unknown0_100, duration); }
	static void TASK_SMART_FLEE_CHAR_PREFERRING_PAVEMENTS(Ped ped, Ped fleeFromPed, float unknown0_100, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SMART_FLEE_CHAR_PREFERRING_PAVEMENTS, ped, fleeFromPed, unknown0_100, duration); }
	static void TASK_SMART_FLEE_POINT(Ped ped, float x, float y, float z, float unknown0_100, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SMART_FLEE_POINT, ped, x, y, z, unknown0_100, duration); }
	static void TASK_SMART_FLEE_POINT_PREFERRING_PAVEMENTS(Ped ped, float x, float y, float z, float radius, int time_prob) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SMART_FLEE_POINT_PREFERRING_PAVEMENTS, ped, x, y, z, radius, time_prob); }
	static void TASK_STAND_GUARD(Ped ped, float x, float y, float z, float Unk460, float Unk461, b8 Unk462, int Unk463) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_STAND_GUARD, ped, x, y, z, Unk460, Unk461, Unk462, Unk463); }
	static void TASK_STAND_STILL(Ped ped, int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_STAND_STILL, ped, duration); }
	static void TASK_START_SCENARIO_AT_POSITION(Ped ped, ScriptAny Unk464, ScriptAny Unk465, ScriptAny Unk466, ScriptAny Unk467, ScriptAny Unk468) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_START_SCENARIO_AT_POSITION, ped, Unk464, Unk465, Unk466, Unk467, Unk468); }
	static void TASK_START_SCENARIO_IN_PLACE(Ped ped, ScriptAny Unk469, ScriptAny Unk470) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_START_SCENARIO_IN_PLACE, ped, Unk469, Unk470); }
	static void TASK_SWAP_WEAPON(Ped ped, unsigned int weapon) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SWAP_WEAPON, ped, weapon); }
	static void TASK_SWIM_TO_COORD(Ped ped, float x, float y, float z) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SWIM_TO_COORD, ped, x, y, z); }
	static void TASK_TIRED(Ped ped, int Unk471) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_TIRED, ped, Unk471); }
	static void TASK_TOGGLE_DUCK(Ped ped, int Unk472) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_TOGGLE_DUCK, ped, Unk472); }
	static void TASK_TOGGLE_PED_THREAT_SCANNER(Ped ped, b8 Unk473, b8 Unk474, b8 Unk475) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_TOGGLE_PED_THREAT_SCANNER, ped, Unk473, Unk474, Unk475); }
	static void TASK_TURN_CHAR_TO_FACE_CHAR(Ped ped, Ped targetPed) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_TURN_CHAR_TO_FACE_CHAR, ped, targetPed); }
	static void TASK_TURN_CHAR_TO_FACE_COORD(Ped ped, float x, float y, float z) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_TURN_CHAR_TO_FACE_COORD, ped, x, y, z); }
	static void TASK_USE_MOBILE_PHONE(Ped ped, b8 use) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_USE_MOBILE_PHONE, ped, use); }
	static void TASK_USE_MOBILE_PHONE_TIMED(Ped ped, unsigned int duration) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_USE_MOBILE_PHONE_TIMED, ped, duration); }
	static void TASK_USE_NEAREST_SCENARIO_TO_POS(Ped ped, ScriptAny Unk476, ScriptAny Unk477, ScriptAny Unk478, ScriptAny Unk479) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_USE_NEAREST_SCENARIO_TO_POS, ped, Unk476, Unk477, Unk478, Unk479); }
	static void TASK_USE_NEAREST_SCENARIO_TO_POS_WARP(Ped ped, ScriptAny Unk480, ScriptAny Unk481, ScriptAny Unk482, ScriptAny Unk483) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_USE_NEAREST_SCENARIO_TO_POS_WARP, ped, Unk480, Unk481, Unk482, Unk483); }
	static void TASK_WANDER_STANDARD(Ped ped) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_WANDER_STANDARD, ped); }
	static void TASK_WARP_CHAR_INTO_CAR_AS_DRIVER(Ped ped, Vehicle vehicle) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_WARP_CHAR_INTO_CAR_AS_DRIVER, ped, vehicle); }
	static void TASK_WARP_CHAR_INTO_CAR_AS_PASSENGER(Ped ped, Vehicle vehicle, unsigned int seatIndex) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_WARP_CHAR_INTO_CAR_AS_PASSENGER, ped, vehicle, seatIndex); }
	...
	static void REQUEST_ANIMS(const char* animName) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_REQUEST_ANIMS, animName); }
...
//	static void SET_GROUP_DECISION_MAKER(Group group, DecisionMaker dm) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_SET_GROUP_DECISION_MAKER, group, dm); }
	static void TASK_SET_CHAR_DECISION_MAKER(Ped ped, DecisionMaker dm) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SET_CHAR_DECISION_MAKER, ped, dm); }
	static void TASK_SET_COMBAT_DECISION_MAKER(Ped ped, DecisionMaker dm) { NativeInvoke::Invoke< ScriptVoid>(NATIVE_TASK_SET_COMBAT_DECISION_MAKER, ped, dm); }
...
//	static b8 NETWORK_IS_SESSION_ADVERTISED() { return NativeInvoke::Invoke< b8>(NATIVE_NETWORK_IS_SESSION_ADVERTISED); }
	...
	static Texture GET_TEXTURE(TextureDict dictionary, const ch* textureName) { return NativeInvoke::Invoke< Texture>(NATIVE_GET_TEXTURE, dictionary, textureName); }
	static TextureDict GET_TXD(const ch* txdName) { return NativeInvoke::Invoke< TextureDict>(NATIVE_GET_TXD, txdName); }
