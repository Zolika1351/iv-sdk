...
public:
	...
	*/
	...
	{
		return ((void(__cdecl*)(uint32_t, uint32_t, uint32_t, CVector*, CVector*, CVector*, CVector*, float, uint32_t, uint32_t, float, float, float, uint32_t, uint32_t, uint32_t))(Addresses::nStoreStaticShadow))(a1, a2, nFlags, pVec1, pVec2, vPos, vColor, fIntensity, texHash, a10, fRange, a12, a13, a14, a15, nID);
	}
};