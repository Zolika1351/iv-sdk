...
namespace plugin
{
	...
	void PickAddressesByVersion()
	{
		...
		case VERSION_1070:
			...
			Addresses::nms_nGameClockForcedMinutes = gBaseAddress + 0xDD52F0;
			Addresses::nms_nGameClockForcedHours = gBaseAddress + 0xDD5308;
			Addresses::nCurrentDay = gBaseAddress + 0xDD5310;
			Addresses::nms_nGameClockSeconds = gBaseAddress + 0xDD530C;
			Addresses::nms_nGameClockMinutes = gBaseAddress + 0xDD52FC;
			Addresses::nms_nGameClockHours = gBaseAddress + 0xDD5300;
			Addresses::nms_nGameClockDays = gBaseAddress + 0xDD5314;
			Addresses::nms_nGameClockMonth = gBaseAddress + 0xDD52F8;
		...
		case VERSION_1080:
			...
			Addresses::nms_nGameClockForcedMinutes = gBaseAddress + 0xD51684;
			Addresses::nms_nGameClockForcedHours = gBaseAddress + 0xD5169C;
			Addresses::nCurrentDay = gBaseAddress + 0xD516A4;
			Addresses::nms_nGameClockSeconds = gBaseAddress + 0xD516A0;
			Addresses::nms_nGameClockMinutes = gBaseAddress + 0xD51690;
			Addresses::nms_nGameClockHours = gBaseAddress + 0xD51694;
			Addresses::nms_nGameClockDays = gBaseAddress + 0xD516A8;
			Addresses::nms_nGameClockMonth = gBaseAddress + 0xD5168C;
